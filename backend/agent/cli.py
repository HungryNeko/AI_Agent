...
from agent.graph import new_chat_state, run_agent, run_turn
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--web-search-mode", choices=["off", "auto"], default="off")
    parser.add_argument(
        "--web-search-provider",
    ...
    parser.add_argument("--rag-mode", choices=["off", "on", "auto"], default="off")
